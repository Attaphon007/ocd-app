          ...
          <div id="wrapper">
            <div>
              ...
              <ul className="ml-5" style={{ listStyleType: "disc" }}>
                ...
                <li>
                  อธิบายว่าประสิทธิผลขององค์การเกิดจากความสอดคล้อง (Congruency)
                  ขององค์ประกอบต่างๆ ขององค์การ
                </li>
              </ul>
              <p>
                <strong>
              ...
              <ul className="ml-5" style={{ listStyleType: "disc" }}>
                <li>
                  สิ่งแวดล้อม
                  ทรัพยากรและประวัติศาสตร์เป็นปัจจัยที่มีอิทธิพลต่อการกำหนดกลยุทธ์ของแต่ละองค์การ
                </li>
              </ul>
            </div>
          </div>

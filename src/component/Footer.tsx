        ...
        <div className="container bottom_border">
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6 col">
              <h5 className="headin5_amrc col_white_amrc pt2">ติดต่อเรา</h5>
              {/*headin5_amrc*/}
              <p className="mb10">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col">
              <h5 className="headin5_amrc col_white_amrc pt2">ช่องทางติดตาม</h5>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <h5 className="headin5_amrc col_white_amrc pt2">ช่องทางรวดเร็ว</h5>
              {/*headin5_amrc*/}

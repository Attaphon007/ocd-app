              ...
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Organization Intercvenhtion/Organization Intercvenhtion 1-41.pdf"
                      target="_blank"
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Organization Intercvenhtion/Organization Intercvenhtion 42-75.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Organization Intercvenhtion/Organization Intercvenhtion 76-111.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Organization Intercvenhtion/Organization Intercvenhtion 112-142.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural Interventional/Technostructural Interventional-1-32.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การออกแบบงาน{" "}
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural Interventional/Technostructural Interventional-33-54.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การ coaching
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural Interventional/Technostructural Interventional-55-77.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การสร้างทีม
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural Interventional/Technostructural Interventional-78-123.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
